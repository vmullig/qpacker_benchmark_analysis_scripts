...
do
	...
	TWOTHOUSANDQPATH = "../../../from_Mohit_2000Q/2000Q_data/qpacker_problem_description_$f_short/"
	...
	then
		...
		then
			echo "$TFILE EXISTS"
			python3 ../analysis/get_all_slns.py ../../../../problems/qpacker_problem_description_$f\_full.txt $TWOTHOUSANDQPATH ./ $TFILE $RFILE >analysis.log
		else
			#echo "$TFILE DNE"
