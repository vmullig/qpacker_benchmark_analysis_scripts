...
if( len(qpacker_rotassignment_counts) > 0 ) :
    ...
    print( "Best QPacker solution:\tNONE" )
    print( "Best QPacker solution ref2015 energy:\tNONE" )
...
if solution_path_2000Q != "NONE" :
    ...
    if( len(qpacker_2000Q_rotassignment_counts) > 0 ) :
        ...
        print( "Best QPacker 2000Q solution:\tNONE" )
        print( "Best QPacker 2000Q solution ref2015 energy:\tNONE" )
